...
for i=subjects
    ...
    for j=1:2
        ...
        [~,peaks_tb_ind]=findpeaks(teb2,"MinPeakdistance",800);
        ...
        if method=="periodogram" | method=="all"
            [HRV_ind,frr,pxxrr]=CalcIndices(rr_taco_new*1000,t_re,"periodogram");
            [QTV_ind,fqt,pxxqt]=CalcIndices(qt_taco_new*1000,t_re,"periodogram");
            ...
            if plot_flag 
                ...
                if plot_rr
                    [~,f,pxx]=CalcIndices(rtime_taco_new*1000,t_re,"periodogram");
        ...
        if method=="welch" | method=="all"
            [HRV_ind,frr,pxxrr]=CalcIndices(rr_taco_new*1000,t_re,"welch");
            [QTV_ind,fqt,pxxqt]=CalcIndices(qt_taco_new*1000,t_re,"welch");
            ...
            if plot_flag 
               ...
               if plot_rr
                   [~,f,pxx]=CalcIndices(rtime_taco_new*1000,t_re,"welch");
        ...
        if method=="lomb"| method=="all"
            [HRV_ind,frr,pxxrr]=CalcIndices(rr_new*1000,t,"lomb");
            [QTV_ind,fqt,pxxqt]=CalcIndices(qt_new*1000,t,"lomb");
            ...
            if plot_flag 
                ...
                if plot_rr
                   [~,f,pxx]=CalcIndices(rtime_new*1000,t,"lomb");
